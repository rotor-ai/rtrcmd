...
class TrimDialog(QWidget):
    ...
    def __init__(self, trim):
        ...
        grid_layout.addWidget(self.lbl_throttle_fwd_max, 4, 0)
        grid_layout.addWidget(self.sb_throttle_fwd_max, 4, 1)
        grid_layout.addWidget(self.lbl_throttle_fwd_min, 5, 0)
        grid_layout.addWidget(self.sb_throttle_fwd_min, 5, 1)
        grid_layout.addWidget(self.lbl_throttle_rev_max, 6, 0)
        grid_layout.addWidget(self.sb_throttle_rev_max, 6, 1)
        grid_layout.addWidget(self.lbl_throttle_rev_min, 7, 0)
        grid_layout.addWidget(self.sb_throttle_rev_min, 7, 1)
        grid_layout.addWidget(self.btn_apply, 8, 1)
