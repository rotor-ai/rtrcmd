...
class SteeringWheelTest(unittest.TestCase):
    ...
    def test_should_set_to_center_if_neutral(self):
        ...
        self.test_obj.set_steering('N100')
        self.assertEqual(Constants.SERVO_CENTER_PWM_VALUE, self.test_obj.servo_ref.value)
